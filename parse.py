...
link_found_add = '''http://data.eastmoney.com/zlsj/zlsj_list.aspx?type=ajax&st=6&sr=-1&p=1&ps=3000&jsObj=aJlEvHvx&stat=1&cmd=1&date=2017-12-31'''
...
link_min = '''http://data.eastmoney.com/DataCenter_V3/gdhs/GetList.ashx?changerate=<0&pagesize=5000&page=1&sortRule=-1&sortType=NoticeDate&js=var EcKRhiOp&rt=50554649'''
